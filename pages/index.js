...
export default function Tweet({ session }) {
            ...
            <div className="flex flex-col flex-grow ml-4">
              ...
              <div className="flex items-center space-x-4">
                {!tweet.likedBy.includes(session.user.id) &&
                  <button className="flex items-center focus:outline-none text-xs text-gray-300 hover:text-red-300" onClick={() => like(tweet)}>
                ...
                {tweet.likedBy.includes(session.user.id) &&
                  <button className="flex items-center focus:outline-none text-xs text-red-500 hover:text-red-300" onClick={() => dislike(tweet)}>
                    <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                    </svg>
